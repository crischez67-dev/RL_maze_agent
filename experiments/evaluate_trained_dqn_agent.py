...
total_collisions_final = sum(result["collision"] for result in results)
...
collision_final_rate = total_collisions_final / num_episodes * 100
...
print(f"Colisiones finales: {total_collisions_final}")
...
print(f"Tasa de colisión final: {collision_final_rate:.2f}%")
