...
CSV_FILE = "results/untrained_dqn_agent_metrics.csv"
...
print("\nMétricas del DQNAgent sin entrenar:")
...
plot_metric(
    ...
    title="Recompensa total por episodio - DQNAgent sin entrenar",
    xlabel="Episodio",
    ylabel="Recompensa total",
    output_file="results/untrained_dqn_agent_rewards.png",
)
...
plot_metric(
    ...
    x_column="episode",
    y_column="steps",
    title="Pasos por episodio - DQNAgent sin entrenar",
    xlabel="Episodio",
    ylabel="Pasos",
    output_file="results/untrained_dqn_agent_steps.png",
)