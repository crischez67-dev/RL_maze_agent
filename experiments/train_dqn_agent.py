...
for episode in range(1, num_episodes + 1):
    ...
    if episode % 10 == 0:
        ...
        recent_collisions = sum(result["collision"] for result in recent_results)
        ...
        print(
            f"Episodio {episode:03d} | "
            f"epsilon={epsilon:.3f} | "
            f"reward_prom_10={recent_average_reward:.2f} | "
            f"metas_10={recent_goals} | "
            f"colisiones_10={recent_collisions} | "
            f"timeouts_10={recent_timeouts}"
        )
